...
- [x] **Step 1: Extend capture script with observation-only promise rejection storage**
...
- [x] **Step 2: Separate blocking loader from busy observation**
...
- [x] **Step 3: Select one effective JS channel per shell**
...
- [x] **Step 4: Correct loader classification**
...
- [x] **Step 5: Improve loader appearance wait**
...
- [x] **Step 6: Update per-form detail text**
...
- [x] **Step 7: Run static Task 1 verification**
...
- [x] **Step 1: Add exact known-noise classifiers**
...
- [x] **Step 2: Render actionable network events only per form**
...
- [x] **Step 3: Render observation-only capture events without duplicate JS**
...
- [x] **Step 4: Run focused renderer probes**
...
- [x] **Step 1: Expose skipped metadata by canonical path**

Add `skipped_form(path)` returning a copied registry record or `None`.

- [x] **Step 2: Build active and skipped records together**
...
- [x] **Step 5: Extend monitor payload and summary**
...
{
  "schema_version": 3,
  "inventory": {"total": 100, "active": 88, "intentional_skips": 12},
...
- [x] **Step 3: Prefer the first form issue as deterministic reason**
...
- [x] **Step 4: Hide empty Markdown fields and show form issues**
...
- [x] **Step 5: Probe the existing failed Allure artifact**
...
- [x] **Step 1: Update the improvement plan header/status**
...
- [x] **Step 2: Record loader/busy and browser evidence**
...
- [x] **Step 3: Update A2 current behavior**
...
- [x] **Step 4: Update reporting and summary contracts**
...
- [x] **Step 1: Parse changed Python files**
...
- [x] **Step 2: Run focused pure-function probes**
...
- [x] **Step 3: Run repository-safe validators**
