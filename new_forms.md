...
> (`tests/smoke/test_life_cycle/test_a2_admin_forms.py`) yig'iladi.
...
- **LIVE tasdiqlangan** — `test_a2_admin_forms.py`, 2026-07-08, red_test @ app3.greenwhite.uz/xtrade, 24/24 passed.
...
| trade/rep/mbi/tmcg/shelf_share | Торговый маркетинг → Отчеты → «Конструктор отчетов по долям на полках» |
...
- Barcha a2 formalar ADMIN — angular menyu orqali ochiladi. Alohida head test yo'q; hammasi `test_a2_admin_forms.py` da.
