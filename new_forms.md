...
- **LIVE tasdiqlangan** — `test_a2_admin_menu_forms.py`, 2026-07-27, red_test @ app3.greenwhite.uz/xtrade, 22/22 passed.
...
- Barcha a2 formalar ADMIN — angular menyu orqali ochiladi. Alohida head test yo'q; hammasi `test_a2_admin_menu_forms.py` da.
