...
Flowni consumer domaini yonidagi mavjud `flow_<domain>/` papkasida saqla.
Setup, Order, Visit va Report uchun joriy yo'llar
[project-context.md](../project-guide/references/project-context.md#flow-va-page-object-joylashuvi)da.
Domainlararo umumiy authorization `tests/smoke/flows/flow_authorization.py`da qoladi.
...
- Migratsiyaga mos flow uchun `AutoBasePage` ishlat; explicit legacy/A2
  primitive'lari `BasePage`/`AngularBasePage`da alohida qoladi. Tanlash kontrakti
  [ui-patterns.md](../smartup-guide/references/ui-patterns.md#page-object-tanlash)da.
...
- Order testlari ko'p yoziladi; orderga tegishli takrorlanadigan harakatlar `tests/smoke/test_life_cycle/flow_order/` ichidagi alohida flow funksiyalarga ajratilsin va yangi order case'larda shu flowlardan foydalanilsin.
...
2. Consumer domainidagi o'xshash mavjud flowlarni va umumiy authorizationni ko'r
3. Legacy yoki A2 DOM kontraktini aniqlab, mos page-objectni tanla
4. Mos domain papkasida flow faylini yarat
