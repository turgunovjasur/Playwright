"""100 000 xarid summasiga 5% chegirma beruvchi aksiya yaratish."""
...
pytestmark = [allure.epic("Smoke"), allure.feature("Aksiya Setup"), allure.story("03 - 100 000 summaga 5% chegirma aksiyasi")]

# ----------------------------------------------------------------------------------------------------------------------


def run_amount_discount(page, code):
    """100 000 xarid summasiga 5% chegirma beruvchi aksiya yaratish.
    ...
    5. Скидка bonusi: setup mahsulotiga 5% berish.
    ...
    with allure.step("5 - 5% chegirmani belgilash"):
        base.ui_select(label="Тип бонуса", value="Скидка")
        ...
        base.input(ng_model="product.value", value="5", press_tab=True)
        base.ui_select(label="Тип условия", expect_value="Обычный")
    ...
    with allure.step("8 - Aksiya setup ma'lumotlarini saqlash"):
        ...
        save_data("action_amount_discount", action_data)

# ----------------------------------------------------------------------------------------------------------------------


@allure.title("03 - 100 000 summaga 5% chegirma aksiyasi")
